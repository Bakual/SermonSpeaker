...
<h4>Adding a new sermon</h4>
	To add a new sermon (mp3, flv and wmv files are currently supported, you should select the "<b>Media Manager</b>" button.<img src="<?php echo JURI::root(); ?>components/com_sermonspeaker/images/upload.png" height="48" width="48" border="0" alt="Media Manager" /><br/>
...
<h4>Additional files</h4>
  You can publish an additional file (eg Slides, Notes etc) among your sermons. To do so, simply enter the path in the "Additional file name" box in the series screen. Use the format
  ...
  Sermonspeaker will add a icon depending on the filetype. If you want to replace the built-in icons, you can do this by placing them in the 
