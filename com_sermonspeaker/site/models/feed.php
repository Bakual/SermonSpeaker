...
class SermonspeakerModelFeed extends JModelLegacy
{
	function getData()
	{
		...
		$query->select('sermons.sermon_date, sermons.title, sermons.audiofile, sermons.videofile, sermons.notes, sermons.sermon_time, sermons.id, sermons.picture, sermons.custom1, sermons.custom2');
