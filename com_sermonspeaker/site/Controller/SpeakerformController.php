 ...
 * @since  3.4
 */
class SpeakerformController extends FormController
{
	protected $view_item = 'speakerform';

	protected $view_list = 'speakers';

	protected $context = 'speakerform';
	...
	protected function postSaveHook(BaseDatabaseModel $model, $validData = array())
	{
		...
		if ($task == 'save')
		{
			$this->setRedirect(Route::_('index.php?option=com_sermonspeaker&view=speakers', false));
		}
	}
