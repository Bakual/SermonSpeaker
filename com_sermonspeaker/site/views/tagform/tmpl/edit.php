...
<?php endif; ?>
<form action="<?php echo JRoute::_('index.php?option=com_sermonspeaker&view=tagform&s_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
		...
		<div class="formelm-buttons">
			...
			<button type="button" onclick="Joomla.submitbutton('tagform.cancel')">
