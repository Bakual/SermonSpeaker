...
?>
<div class="com-sermonspeaker-sermons<?php echo $this->pageclass_sfx; ?> com-sermonspeaker-sermons-columns">
	...
	<?php endif; ?>
	<form action="<?php echo JFilterOutput::ampReplace(Uri::getInstance()->toString()); ?>" method="post"
