...
<form action="#" method="post" name="adminForm" id="adminForm" class="form-validate form-inline">
	...
	<table>
		<tr>
			<th rowspan="2" valign="bottom"><label for="book"><?php echo JText::_('COM_SERMONSPEAKER_BOOK'); ?></label>
			</th>
			...
			<td>
				<select name="from[book]" class="input-medium" id="book">
					...
					<optgroup label="<?php echo JText::_('COM_SERMONSPEAKER_OLD_TESTAMENT'); ?>">
						...
						for ($i = 1; $i < 40; $i++): ?>
							<option
								value="<?php echo $i; ?>"><?php echo JText::_('COM_SERMONSPEAKER_BOOK_' . $i); ?></option>
						<?php endfor; ?>
					</optgroup>
