...
?>
<form action="<?php echo Route::_('index.php?option=com_sermonspeaker&view=series'); ?>" method="post" name="adminForm"
	  id="adminForm">
	<div class="row">
		<div class="col-md-12">
				...
				<?php else : ?>
					<table class="table" id="serieList">
						<caption id="captionTable" class="sr-only">
							<?php echo Text::_('COM_SERMONSPEAKER_SERIES_TABLE_CAPTION'); ?>
						...
						<tr>
							...
							<th scope="col" style="width:1%" class="text-center d-none d-md-table-cell">
								<?php echo HTMLHelper::_('searchtools.sort', 'JDEFAULT', 'series.home', $listDirn, $listOrder); ?>
							</th>
									...
									<?php if ($canEdit || $canEditOwn) : ?>
										<a class="btn btn-sm btn-warning"
										   href="index.php?option=com_sermonspeaker&task=serie.reset&id=<?php echo $item->id; ?>">
											<span class="icon-loop hasTooltip"
