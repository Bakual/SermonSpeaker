...
<form action="#" method="post" name="adminForm" id="item-form" class="form-validate form-inline">
	<table>
		<tr>
			<th rowspan="2" valign="bottom"><label for="book"><?php echo Text::_('COM_SERMONSPEAKER_BOOK'); ?></label></th>
		...
		<tr>
			<td>
				<select name="from[book]" class="input-medium advancedSelect" id="book">
					...
					<?php for ($i = 1; $i < 40; $i++): ?>
						<option value="<?php echo $i; ?>"><?php echo Text::_('COM_SERMONSPEAKER_BOOK_'.$i); ?></option>
					<?php endfor; ?>
					</optgroup>
