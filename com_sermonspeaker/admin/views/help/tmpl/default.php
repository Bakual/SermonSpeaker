...
?>
<form action="<?php echo Route::_('index.php?option=com_sermonspeaker&view=help'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
			...
			<div id="j-main-container" class="j-main-container">
				...
				<div class="card m-3">
					<div class="card-body">
						...
						<div class="card-text">SermonSpeaker includes the following extern classes besides the players mentioned above:
							<ul>
