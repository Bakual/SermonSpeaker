...
/**
 * Plug-in to show the JW Player 8 from http://www.jwplayer.com/
 *
 * @since  1.0.0
 */
class PlgSermonspeakerJwplayer8 extends SermonspeakerPluginPlayer
{
	/**
	...
	public function onGetPlayer($context, &$player, $items, $config)
	{
		...
		$dimensions['audioheight'] = $this->params->get('aheight', '33');
