...
<table border="0" cellpadding="2" cellspacing="10" width="100%">
	...
	if($this->rows) {
		...
		foreach($this->rows as $row) { 
			...
			<?php } ?>
				<td align="left"><a TITLE="<?php echo JText::_('SINGLE_SERMON_HOOVER_TAG'); ?>" href="<?php echo JRoute::_("index.php?view=sermon&id=$row->slug&Itemid=$this->itemid"); ?>"><?php echo $row->sermon_title; ?></a></td>
