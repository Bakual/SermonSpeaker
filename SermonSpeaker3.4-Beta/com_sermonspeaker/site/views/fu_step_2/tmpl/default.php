...
?>
<table border="0"> <!-- todo: check if nesting of <tr> in <tr> in this table (around <form> is neccessary -->
	<tr>
		<td width ="50">&#160;</td>
	...
	<form name="fu_createsermon" method="post" enctype="multipart/form-data" >
		...
		<tr>
			...
			<td> &nbsp; <input class="text_area" type="text" name="sermon_time" id="sermon_time" size="10" maxlength="250" value="<?php echo @$this->fileInfo['playtime_string'];?>" /> </td>
