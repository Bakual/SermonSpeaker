		...
		<div id="cpanel">
			<div style="float: left;"><div class="icon">
				<a href="index.php?option=<?php echo $option; ?>&view=speakers">
					<img border="0" align="middle" alt="<?php echo JText::_('SPEAKERSNAV'); ?>" src="<?php echo JURI::root()."components/".$option."/images/speakers.png"; ?>"/>
					<span><?php echo JText::_('SPEAKERSNAV'); ?></span>
				</a>
			</div></div>
			<div style="float: left;"><div class="icon">
				<a href="index.php?option=<?php echo $option; ?>&view=sermons">
					<img border="0" align="middle" alt="<?php echo JText::_('SERMONSNAV'); ?>" src="<?php echo JURI::root()."components/".$option."/images/sermon.png"; ?>"/>
					<span><?php echo JText::_('SERMONSNAV'); ?></span>
				</a>
			</div></div>
			<div style="float: left;"><div class="icon">
				<a href="index.php?option=<?php echo $option; ?>&view=series">
					<img border="0" align="middle" alt="<?php echo JText::_('SERIESNAV'); ?>" src="<?php echo JURI::root()."components/".$option."/images/series.png"; ?>"/>
					<span><?php echo JText::_('SERIESNAV'); ?></span>
				</a>
			</div></div>
			<div style="float: left;"><div class="icon">
				<a href="index.php?option=<?php echo $option; ?>&view=statistics">
					<img border="0" align="middle" alt="<?php echo JText::_('STATISTICS'); ?>" src="<?php echo JURI::root()."components/".$option."/images/stats.png"; ?>"/>
					<span><?php echo JText::_('STATISTICS'); ?></span>
				</a>
			</div></div>
			<div style="float: left;"><div class="icon">
				<a href="index2.php?option=<?php echo $option; ?>&view=help">
					<img border="0" align="middle" alt="<?php echo JText::_('HELP'); ?>" src="<?php echo JURI::root()."components/com_sermonspeaker/images/help.png"; ?>"/>
