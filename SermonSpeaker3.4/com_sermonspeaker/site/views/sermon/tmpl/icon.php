...
<div id="sermon-container">
	...
	<div id="sermon-infobox">
		<?php 
			...
			<div id="sermon-player-container">
				<div class="ss-player"><object type="application/x-shockwave-flash" data="<?php echo $playerPath;	?>player.swf" id="audioplayer1" height="24" width="290">
	...
	<?php } // if client_col_player
		...
		<div class="ss-fields-container">
			<div class="ss-field field-series" title="<?php echo JText::_('COM_SERMONSPEAKER_SERIES'); ?>">
...
echo '</div>';
?>
<div class="hits" title="<?php echo JText::_('COM_SERMONSPEAKER_HITS'); ?>"><?php echo JText::_('COM_SERMONSPEAKER_HITS').': '.$this->row->hits; ?></div>
<table width="100%">
	<?php
