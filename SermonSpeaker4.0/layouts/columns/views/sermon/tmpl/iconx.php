...
JHTML::stylesheet('iconx.css', 'media/com_sermonspeaker/css/');
	...
	<div id="sermon-player-container">
		...
		if (in_array('sermon:player', $this->columns) && $this->item->videofile) :
			...
			<div class="ss-player-video">
				<a href="<?php echo JURI::current(); ?>" onclick="popup = window.open('<?php echo  JRoute::_(SermonspeakerHelperRoute::getSermonRoute($this->item->slug).'&layout=popupx&type=video&tmpl=component'); ?>', 'PopupPage', 'height=<?php echo $player->popup['height']; ?>,width=<?php echo $player->popup['width']; ?>,scrollbars=yes,resizable=yes'); return false">
