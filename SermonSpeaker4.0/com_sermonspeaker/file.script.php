	...
	function install($parent) {
		...
		if ($demo == 1) {
			...
			$query = "INSERT INTO `#__sermon_speakers` "
				."(`id`,`name`,`alias`,`website`,`intro`,`bio`,`pic`,`state`,`ordering`,`created_by`,`created`) VALUES"
			...
			$query = "INSERT INTO `#__sermon_series` "
				."(`id`,`series_title`,`alias`,`series_description`,`state`,`ordering`,`created_by`,`created`) VALUES"
				."(1,'General Topics','general-topics','Topics of general interest.',1,1,62,'2006-03-28')";
			$database->setQuery($query);
			$database->Query();
		
			//Sermon
			$query = "INSERT INTO `#__sermon_sermons` "
			."(`id`,`speaker_id`,`series_id`,`sermon_path`,`sermon_title`,`alias`,`sermon_number`,`sermon_date`,`sermon_time`,`notes`,`ordering`,`created_by`,`created`,`state`) VALUES"
			."(1,1,1,'/components/com_sermonspeaker/media/default_sermon.mp3','The Sin of Booze','the-sin-of-booze','1','2006-03-28','00:00:05','Borrowed from sermonaudio.com',1,62,'2006-03-28',1)";
			$database->setQuery($query);
			$database->Query();
		}
