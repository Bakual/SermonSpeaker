...
<div id="sermon-container">
	...
	<div id="sermon-infobox">
		...
		<div class="ss-fields-container">
			<?php if (in_array('sermon:date', $columns) && ($this->row->sermon_date != "0000-00-00")) : ?>
			...
			<?php endif;
			if (in_array('sermon:length', $columns) && ($this->row->sermon_time != "00:00:00")) : ?>
		...
		<div class="ss-fields-container">
			...
			<?php endif;
			if (in_array('sermon:addfile', $columns) && $this->row->addfile && $this->row->addfileDesc) : ?>
