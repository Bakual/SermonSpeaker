 ...
 * @since		4.0
 */
class JFormFieldSermonpic extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	...
	public function getInput()
	{
		...
		$path = JPATH_ROOT.DS.$params->get('path_sermonpic');
		...
		return JHTML::_('select.genericlist', $images, 'jform[picture]', '', 'file', 'name', $this->value, 'jform_picture');
	}
}
