...
class JFormFieldHits extends JFormField
{
	...
	protected function getInput()
	{
		...
		if ($this->value){
			$return .= '<img src="'.JURI::base().'components/com_sermonspeaker/images/reset.png"'.$onclick.' width="16" height="16" border="0" title="'.JText::_('COM_SERMONSPEAKER_RESET').'" alt="Reset" />';
		}
