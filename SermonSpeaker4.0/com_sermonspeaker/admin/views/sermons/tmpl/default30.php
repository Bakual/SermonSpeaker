	...
	<table class="table table-striped" id="sermonList">
		<thead>
			<tr>
				...
				<th width="10%" class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort',  'JAUTHOR', 'sermons.created_by', $listDirn, $listOrder); ?>
				</th>
				<th width="5%" class="nowrap hidden-phone">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
				...
				<td class="center">
					<div class="btn-group">
						<?php echo JHtml::_('jgrid.published', $item->podcast, $i, 'sermons.podcast_', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
					</div>
				</td>
